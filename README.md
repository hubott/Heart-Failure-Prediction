...
Frontend hosted using AWS S3: http://heart-failure-prediction-model.s3-website-ap-southeast-2.amazonaws.com (currently offline)

Live Backend API: http://3.26.33.59:8000/predict (currently offline)
